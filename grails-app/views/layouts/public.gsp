	...
	<div class="wrapper"
		...
		<header class="main-header">
			...
			<div class="wrapper">
								...
								<li class="dropdown user user-menu"><a href="#"
									...
									<ul class="dropdown-menu">
										...
										<li class="user-header">
											...
											<p>
												Suporte OS<br> <small>Coordena o s3u -
				...
				<aside class="main-sidebar">
					...
					<section class="sidebar">
						...
						<ul class="sidebar-menu">
							...
							<li class="active treeview"><a href="/s3u/ordemDeServico/homeGrafico"> 
							    <i class="fa fa-dashboard"></i> <span>Painel</span>
							</a></li>

							<li><a href="/s3u/ordemDeServico/listarOrdemDeServico">
									<i class="fa fa-th"></i> <span>Listagem de Chamados</span>
							</a></li>
							
							<li class="treeview"><a href="/s3u/ordemDeServico/cadastrarOrdemDeServico"> 
						...
						<!-- 	<li class="treeview">
								<a href="/s3u/funcionarioOs/listarFuncionarioOs"> 
									<i class="fa fa-user"></i> <span>Funcionários </span>
								</a>
							</li>  -->
							
							<li class="treeview">
							   <a href="/s3u/ordemDeServico/graficoOsSituacoes"> 
							   <i class="fa fa-pie-chart"></i> <span>Gráficos OS</span>
							</a></li>

							<li class="treeview"><a href="/s3u/ordemDeServico/pesquisarOrdemDeServico"> 
			    ...
			    <li><a href="/s3u/ordemDeServico/relatorioIluminacao"><i class="fa fa-file-text"></i> Iluminação</a></li>
				<li><a href="/s3u/ordemDeServico/relatorioIluminacaoResumo" ><i class="fa fa-file-text"></i> Resumo iluminação</a></li>
				<li><a href="/s3u/ordemDeServico/relatorioLimpeza" ><i class="fa fa-file-text"></i> Limpeza</a></li>
